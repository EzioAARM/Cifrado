...
public class SdesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (!directorio.exists())
            directorio.mkdir();
        TextView mostrarInformacionDirectorio = (TextView) rootView.findViewById(R.id.info_carpeta_destino_cifrar_sdes);
        ...
        Button examinarArchivoCifrar = (Button) rootView.findViewById(R.id.examinar_cifrar_sdes);
        ...
        final CheckBox sobreescribirArchivo = (CheckBox) rootView.findViewById(R.id.sobreescribir_cifrar_sdes);
        ...
        cifrarArchivo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    EditText nivelesSeparacion = (EditText) rootView.findViewById(R.id.contrasenia_sdes);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent resultData) {
        if (requestCode == READ_REQUEST_CODE_FILE && resultCode == Activity.RESULT_OK) {
            try {
                EditText ubicacionArchivoCifrar = (EditText) rootView.findViewById(R.id.ubicacion_archivo_cifrar_sdes);
